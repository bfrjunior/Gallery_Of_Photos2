...
namespace Galeria_De_Fotos2 {
    ...
    public partial class BD_ClienteDataSet : global::System.Data.DataSet {
        ...
        public partial class alunoDataTable : global::System.Data.TypedTableBase<alunoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public alunoRow AddalunoRow(string nome, string email, string celular) {
...
namespace Galeria_De_Fotos2.BD_ClienteDataSetTableAdapters {
    ...
    public partial class alunoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[aluno] WHERE (([Id] = @Original_Id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_celular = 1 AND [celular] IS NULL) OR ([celular] = @Original_celular)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[aluno] ([nome], [email], [celular]) VALUES (@nome, @email, @ce" +
                "lular);\r\nSELECT Id, nome, email, celular FROM aluno WHERE (Id = SCOPE_IDENTITY()" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[aluno] SET [nome] = @nome, [email] = @email, [celular] = @celular WHERE (([Id] = @Original_Id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_celular = 1 AND [celular] IS NULL) OR ([celular] = @Original_celular)));
SELECT Id, nome, email, celular FROM aluno WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Galeria_De_Fotos2.Properties.Settings.Default.BD_ClienteConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nome, email, celular FROM dbo.aluno";
        ...
        public virtual int Fill(BD_ClienteDataSet.alunoDataTable dataTable) {
        ...
        public virtual BD_ClienteDataSet.alunoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BD_ClienteDataSet.alunoDataTable dataTable = new BD_ClienteDataSet.alunoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BD_ClienteDataSet.alunoDataTable dataTable) {
        ...
        public virtual int Insert(string nome, string email, string celular) {
            if ((nome == null)) {
        ...
        public virtual int Update(string nome, string email, string celular, int Original_Id, string Original_nome, string Original_email, string Original_celular, int Id) {
            if ((nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string email, string celular, int Original_Id, string Original_nome, string Original_email, string Original_celular) {
            return this.Update(nome, email, celular, Original_Id, Original_nome, Original_email, Original_celular, Original_Id);
        }
    }
